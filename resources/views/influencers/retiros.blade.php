...
<div class="container infoContenido pt-5 pl-md-4 pr-md-4 pb-5">
    ...
    <div class="card mt-4">
        <div class="card-body">
            ...
            <div class="row ">
                <!-- Espaciado adicional para claridad -->
                <div class="col-md-6 mt-3">
                    <form id="formRetiro">
                        <div class="input-group">
                            <!-- Grupo de entrada para alinear elementos -->
                ...
                <div class="col-md-6 mt-3">
                    <div class="form-group">
                        <!-- Clase para agrupar inputs con sus etiquetas -->
                ...
                <table id="porRetirar" class="table table-striped table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{!! $status_trans !!}</td>
                            <td>
                                <input type="checkbox" id="checkbox{{ $index }}" class="checkbox" name="seleccionar[]"
                                    value="{{ $comprasFiltrada['codigo_compra'] }}">
                            </td>
                        </tr>
                        @endif
                        @endforeach
            ...
            <div class="table-responsive">
                <table id="misRetiros" class="table table-striped table-bordered">
                    ...
                    <tbody>
                        ...
                        @php
                        $cuentasBancarias = json_decode($operacion["cuentasBancarias"], true);
                        @endphp
                        <tr>
                            <td>

                                @if($operacion->estado == 5)
                                ---------
                                @elseif (empty($operacion->numero_operacion))
                            ...
                            <td>
                                ...
                                @elseif (empty($operacion->cuentasBancarias))
                                <span class="badge badge-warning py-1 mr-2">
                                    <i class="fas fa-clock" aria-hidden="true"></i>
                                    Procesando
                                </span>
                            ...
                            <td>
                                @if($operacion->estado == 5)
                                <span class="badge badge-danger py-1 mr-2">
                                    Rechazado
                                </span>
                                @elseif (empty($operacion->numero_operacion))
