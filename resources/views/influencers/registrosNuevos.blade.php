@include('layouts.influencers.headerReg')
        ...
        <div class="row">
            ...
            <div class="col-md-4 my-1">
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" value="" id="codigo" name="codigo" aria-describedby="emailHelp" placeholder="DNI / Carnet Extranjeria / RUC">
            ...
            <div class="col-md-4 my-1">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" value="" id="nombres" name="nombres" aria-describedby="emailHelp" placeholder="Nombres">
            ...
            <div class="col-md-4 my-1">
                <div class="form-group">
                    ...
                    <input type="text" value="" class="form-control" id="apPaterno" name="apPaterno" aria-describedby="emailHelp" placeholder="Apellidos Paterno">
            ...
            <div class="col-md-4 my-1">
                <div class="form-group">
                    ...
                    <input type="text" value="" class="form-control" id="apMaterno" name="apMaterno" aria-describedby="emailHelp" placeholder="Apellidos Materno">
            ...
            <div class="col-md-4 my-1">
                <div class="form-group">
                    ...
                    <input type="email" value="" class="form-control" id="email" name="email" aria-describedby="emailHelp" placeholder="Correo">
            ...
            <div class="col-md-4 my-1">
                <div class="form-group">
                    ...
                    <input type="password" class="form-control" value="" id="password" name="password" aria-describedby="emailHelp" placeholder="Cambiar contraseña">
            ...
            <div class="col-md-4 my-1">
                <div class="form-group">
                    ...
                    <input type="tel" value="" class="form-control" id="telfono" name="telfono" aria-describedby="emailHelp" placeholder="Número de teléfono">
            ...
            <div class="col-md-4 my-1">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="razon_social" value="" name="razon_social" value="" aria-describedby="emailHelp" placeholder="Razón Social">
            ...
            <div class="col-md-4 my-1">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="cargo" name="cargo" value="" aria-describedby="emailHelp" placeholder="Cargo/ocupación">
            ...
            <div class="col-md-6 my-1 redSocial">
                <div class="form-group d-flex align-items-center facebook">
                    ...
                    <input type="url" class="form-control" id="facebook" name="facebook" aria-describedby="emailHelp" placeholder="Facebook">
            ...
            <div class="col-md-6 my-1 redSocial">
                <div class="form-group d-flex align-items-center">
                    ...
                    <input type="url" class="form-control" id="linkedIn" name="linkedIn" aria-describedby="emailHelp" placeholder="LinkedIn" value="">
            ...
            <div class="col-md-6 my-1 redSocial">
                <div class="form-group d-flex align-items-center">
                    ...
                    <input type="url" class="form-control" id="instagram" name="instagram" aria-describedby="emailHelp" placeholder="Instagram" value="">
            ...
            <div class="col-md-6 my-1 redSocial">
                <div class="form-group d-flex align-items-center">
                    ...
                    <input type="url" class="form-control" id="tiktok" name="tiktok" placeholder="Tiktok" value="">
...
<style>
    ...
    *:focus {
    ...
    .col-md-6.my-1.redSocial .facebook {
        margin-bottom: 0;
    }
