            ...
            <div class="col-md-4 my-1">
                <div class="form-group">
                    ...
                    <input type="text" value="" class="form-control" id="apPaterno" name="apPaterno"
                        aria-describedby="emailHelp" placeholder="Apellidos Paterno">
            ...
            <div class="col-md-4 my-1">
                <div class="form-group">
                    ...
                    <input type="text" value="" class="form-control" id="apMaterno" name="apMaterno"
                        aria-describedby="emailHelp" placeholder="Apellidos Materno">
            ...
            <div class="col-md-4 my-1">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="razon_social" value="" name="razon_social"
                        value="" aria-describedby="emailHelp" placeholder="Razón Social">
            ...
            <div class="col-md-4 my-1">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="cargo" name="cargo" value=""
                        aria-describedby="emailHelp" placeholder="Cargo/ocupación">
            ...
            <div class="col-md-6 my-1 redSocial">
                <div class="form-group d-flex align-items-center facebook">
                    ...
                    <input type="url" class="form-control" id="facebook" name="facebook"
                        aria-describedby="emailHelp" placeholder="Facebook">
            ...
            <div class="col-md-6 my-1 redSocial">
                <div class="form-group d-flex align-items-center">
                    ...
                    <input type="url" class="form-control" id="linkedIn" name="linkedIn"
                        aria-describedby="emailHelp" placeholder="LinkedIn" value="">
            ...
            <div class="col-md-6 my-1 redSocial">
                <div class="form-group d-flex align-items-center">
                    <div class=" d-flex align-items-center">
                        <svg width="15" height="15" viewBox="0 0 15 15" fill="none"
                            ...
                            <path
                                ...
                                fill="white" />
                            <defs>
                                <radialGradient id="paint0_radial_4064_628" cx="0" cy="0" r="1"
                    ...
                    <input type="url" class="form-control" id="instagram" name="instagram"
                        aria-describedby="emailHelp" placeholder="Instagram" value="">
...
<script src="{{ asset('influencers/js/registroNuevo.js') }}"></script>
