        ...
        <div class="row">
            ...
            <div class="col-xl-4 col-lg-4 col-lg-6 col-md-12 my-1">
                <div class="form-group">
                    ...
                    <input type="text" value="{{ $apellidosMa }}" disabled class="form-control" id="apMaterno"
                ...
                <div class="form-group">
                    <select name="banco" id="banco" class="banco form-control">
                        ...
                        <option value="CompartamosFinanciera"
                            {{ $banco == 'CompartamosFinanciera' ? 'selected' : '' }}>
                ...
                <div class="form-group">
                    <select class="form-control" id="tipCuenta" name="tipCuenta">
                        ...
                        <option value="Cuenta de Ahorro"
                            {{ $tipo_de_cuenta == 'Cuenta de Ahorro' ? 'selected' : '' }}>
                            Cuenta de Ahorro</option>
                        <option value="Cuenta Corriente"
                            {{ $tipo_de_cuenta == 'Cuenta Corriente' ? 'selected' : '' }}>
