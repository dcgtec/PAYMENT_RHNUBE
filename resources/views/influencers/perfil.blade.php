...
@php
    ...
    if (isset($propietario['redes_sociales'])) {
        $redesSocialArray = json_decode($propietario['redes_sociales'], true);
    }
        ...
        <div class="row">
            ...
            <div class="col-md-4 my-1">
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" value="{{ $codigo }}" id="codigo" name="codigo"
            ...
            <div class="col-md-4 my-1">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" value="{{ $nombrePro }}" id="nombres" name="nombres"
            ...
            <div class="col-md-4 my-1">
                <div class="form-group">
                    ...
                    <input type="text" value="{{ $apellidosPa }}" class="form-control" id="apPaterno"
            ...
            <div class="col-md-4 my-1">
                <div class="form-group">
                    ...
                    <input type="text" value="{{ $apellidosMa }}" class="form-control" id="apMaterno"
                        name="apMaterno" aria-describedby="emailHelp" placeholder="Apellidos Materno">
            ...
            <div class="col-md-4 my-1">
                <div class="form-group">
                    ...
                    <input type="tel" value="{{ $telefono }}" class="form-control" id="telfono" name="telfono"
